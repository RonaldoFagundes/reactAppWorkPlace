...
export default function CadReportPageTwo({ navigation }) {
        ...
        >
            ...
            >
                ...
                <View style={styles.containerInfo}>
                    <Text style={styles.textMain}>{` Tela cadastro de relatorio 2`}</Text>
                </View>
                   ...
                   <View style={styles.containerImg}>                   
                       ...
                       {dataRel.img_three && <Image source={{ uri: dataRel.img_three }} style={styles.contentImg} />}
                         ...
                         <LinearGradient
                            ...
                            style={styles.styleBtnOne}
                        >
                            <Pressable onPress={() => {navigation.navigate("CadReportPageOne")}}>
                        ...
                        <LinearGradient
                            ...
                            style={styles.styleBtnOne}
                        >
                            <Pressable onPress={() => {navigation.navigate("CadReportPageThree")}}>
